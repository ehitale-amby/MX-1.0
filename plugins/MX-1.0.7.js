    ...
    try {
      if (!_0x4f77c0) {
        return _0x24125a.reply(
          "*_Example : " + (prefix + _0x2d0eda) + " MX-1.0_*"
        );
      }
    ...
    try {
      if (!_0x4b2154) {
        return _0x22e0c1.reply(
          "*_Example : " + (prefix + _0x3f34e1) + " MX-1.0_*"
        );
      }
      return await textToLogoGenerator(
        _0x22e0c1,
    ...
    try {
      if (!_0x1d8c69) {
        return _0x42806c.reply(
          "*_Example : " + (prefix + _0x20d4b4) + " MX-1.0_*"
        );
      }
      return await textToLogoGenerator(
        _0x42806c,
    ...
    try {
      if (!_0x216b18) {
        return _0x25bc1d.reply(
          "*_Example : " + (prefix + _0x67b214) + " MX-1.0_*"
        );
      }
      return await textToLogoGenerator(
        _0x25bc1d,
    ...
    try {
      if (!_0x1b1b16) {
        return _0x260877.reply(
          "*_Example : " + (prefix + _0x3fd4bb) + " MX-1.0_*"
        );
      }
      return await textToLogoGenerator(
        _0x260877,
    ...
    try {
      if (!_0x50896d) {
        return _0x1ff0b0.reply(
          "*_Example : " + (prefix + _0x56f3bb) + " MX-1.0_*"
        );
      }
      return await textToLogoGenerator(
        _0x1ff0b0,
