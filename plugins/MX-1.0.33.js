...
smd(
  ...
  async (_0x42b3b8, _0x3f3887) => {
    try {
      ...
      if (!_0x1b0897) {
        return _0x42b3b8.reply("Provide me a query ex Who is MX-1.0");
      }
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/themxgamecoder/MX-1.0"
      );
      let _0x1c73f9 = (
        "\nMX-1.0 A simple Mutil Device WhatsApp Bot with rich library Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        (_0x44f98c?.stargazers_count || "None (🥲)") +
        " stars\n  *❲❒❳ Forks:* " +
        (_0x44f98c?.forks_count || "1000+") +
        " forks\n  *❲❒❳ Creator:* MX-GΔMΞCØDΞR\n  *❲❒❳ Created:* " +
        (_0x44f98c?.created_at || "2024/06") +
        "\n  *❲❒❳ Repo:* _https://github.com/themxgamecoder/MX-1.0_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
  ...
  async (_0x2acf30) => {
    try {
      if (
        ...
        if (
          _0x2acf30.reply_text.includes("MX-1.0 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          _0x2dfb59[0].includes("MX-1.0 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
