  ...
  smd(
    ...
    async ({ reply, chat, isGroup, sender, error }) => {
      try {
        ...
        const daily = await eco.daily(sender, "mxgamecoder", 500); //give 500 for daily, can be changed
        if (daily.cd) {
      ...
      try {
        ...
        switch (value) {
          ...
          case "1":
            ...
            const deduct1 = await eco.deduct(user, "mxgamecoder", 100);
            const add1 = eco.giveCapacity(user, "mxgamecoderl", 1000);
            return await message.reply(
          ...
          case "2":
            ...
            const deduct2 = await eco.deduct(user, "mx", 1000);
            const add2 = eco.giveCapacity(user, "mx", 100000);
            return await message.reply(
          ...
          case "3":
            ...
            const deduct3 = await eco.deduct(user, "mxgamecoder", 10000);
            const add3 = eco.giveCapacity(user, "mxgamecoder", 10000000);
            return await message.reply(
  ...
  smd(
    ...
    async (message, match) => {
      try {
        ...
        const deduct = await eco.deduct(user1, "mxgamecoder", value[0]);
        const give = await eco.give(user2, "mxgamecoder", value[0]);
        return await message.reply(
  ...
  smd(
    ...
    async (message) => {
      try {
        ...
        if (mongoschemas == "false")
          return message.reply("*🚦Economy* is not active in current group.");
        const balance = await eco.balance(message.sender, "mxgamecoder"); //Returns wallet, bank, and bankCapacity. Also creates a USer if it doesn't exist.
        return await message.reply(
  ...
  smd(
    ...
    async (message, match) => {
      try {
        ...
        await eco.give(users, "mxgamecoder", parseInt(match.split(" ")[0]));
      ...
      try {
        ...
        switch (random) {
          ...
          case "rob":
            ...
            await eco.deduct(user2, "mxgamecoder", deduff);
            await eco.give(message.sender, "mxgamecoder", deduff);
            await message.reply(
          ...
          case "caught":
            ...
            await eco.deduct(user1, "mxgamecoder", rmoney);
            await message.reply(
  ...
  smd(
    ...
    async (message, match) => {
      try {
        ...
        message.reply(
          media,
          { packname: "mxgamecoder", author: "Economy" },
          "sticker"
        );
        const f = [
          "up",
        ...
        if (r == opp) {
          let give = await eco.give(user, "mxgamecoder", twice); //message.react('⭐️')
          ...
          let deduct = await eco.deduct(user, "mxgamecoder", texts[0]);
